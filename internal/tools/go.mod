...
require (
	...
	github.com/gardener/gardener v1.135.0 // indirect
	...
	k8s.io/code-generator v0.36.0-alpha.2 // indirect
	...
	sigs.k8s.io/controller-runtime/tools/setup-envtest v0.0.0-20260303114320-955f7df464ad // indirect
