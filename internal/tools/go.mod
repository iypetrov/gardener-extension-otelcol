...
require (
	...
	github.com/gardener/gardener v1.140.0 // indirect
	...
	k8s.io/code-generator v0.36.0-rc.0 // indirect
	...
	sigs.k8s.io/controller-runtime/tools/setup-envtest v0.0.0-20260418192536-e4a998cc6b09 // indirect
